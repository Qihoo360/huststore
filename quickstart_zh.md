...
* 如果您试用 **rpm 安装包** ，请不要忘记 **变更目录 `/opt/huststore` 的所有者**，参考 [快速试用](#id_try) 和 [更多](#id_adv) 的相关内容。  
* 如果您试用 **二进制安装包**，请不要忘记 **创建目录 `/opt/huststore` 并修改其所有者**，参考 [快速试用](#id_try) 和 [更多](#id_adv) 的相关内容。  
